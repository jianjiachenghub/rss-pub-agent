...
- For long-running terminal validation tasks (for example pipeline runs, build verification, or end-to-end smoke tests), prefer spawning a sub-agent to run the command and report progress/results back, instead of blocking the main agent thread.
